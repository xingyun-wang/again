...
> **最后更新**：2026-09-11（W1 + W2 + W3 全部 + W4 全部完成）
...
| W3 老师自建题库 CRUD + 作业生成引擎 | ✅ 完成 | T1-T6 全过 |
| W4 作业管理 UI + PDF 导出 | 🔄 **进行中** | T1-T4 全部完成，**前端 UI 5 页全联通** |
| W5-W12 MVP 联调 | ⏳ 待启动 | |
...
| W3-T6 | 端到端集成测试（12 Step 全 PASS） | ✅ | 4aa4fb6 |
| W4-T1 | Ant Design 5 + react-router-dom + 4 路由 + 侧边栏 | ✅ | 本次 |
| W4-T2 | 题目 CRUD + 班级/学生管理 + 批量导入 + 改密 | ✅ | 本次 |
| W4-T3 | 作业生成（反马太 + 老师指定每档题数 + 章节过滤） | ✅ | 本次 |
| W4-T4 | 审阅手动调档 + 发布 + 作业列表 + 详情 | ✅ | 本次 |
